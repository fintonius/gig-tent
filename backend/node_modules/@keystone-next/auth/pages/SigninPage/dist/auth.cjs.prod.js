...
var SigninContainer = require('../../../dist/SigninContainer-a83ca4e5.cjs.prod.js');
...
const SigninPage = ({
  ...
  return core.jsx(SigninContainer.SigninContainer, null, core.jsx(core.Stack, {
    gap: "xlarge",
    as: "form",
  ...
  }), mode === 'signin' && core.jsx(fields.TextInput, {
    name: "password",
    value: state.secret,
    onChange: e => setState(_objectSpread(_objectSpread({}, state), {}, {
    ...
    type: "submit"
  }, "Sign In"), core.jsx(button.Button, {
    weight: "none",
    tone: "active",
