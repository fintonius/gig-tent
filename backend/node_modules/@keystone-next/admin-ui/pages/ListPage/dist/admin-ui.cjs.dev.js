...
var CellLink = require('../../../dist/CellLink-4bc1304b.cjs.dev.js');
...
var router_dist_adminUi = require('../../../router/dist/admin-ui.cjs.dev.js');
var GraphQLErrorNotice = require('../../../dist/GraphQLErrorNotice-b1bfbf1d.cjs.dev.js');
var CreateItemDrawer = require('../../../dist/CreateItemDrawer-a2e46103.cjs.dev.js');
...
function Pagination({
  ...
  return core.jsx(core.Center, null, core.jsx(core.Stack, {
    across: true,
    gap: "small"
  }, pages), core.jsx(PaginationLabel, {
    currentPage: currentPage,
    pageSize: pageSize,
    plural: list.plural,
...
function PaginationLabel({
  ...
  return core.jsx("span", null, "Showing ", core.jsx("strong", null, count));
}
...
function useQueryParamsFromLocalStorage(listKey) {
  ...
  React.useEffect(() => {
    let hasSomeQueryParamsWhichAreAboutListPage = Object.keys(router$1.query).some(x => x.startsWith('!') || x === 'page' || x === 'pageSize' || x === 'fields');
...
const ListPage = ({
  ...
  let listViewFieldModesByField = React.useMemo(() => {
  ...
  'Error...' : data && metaQuery.data ? core.jsx(React.Fragment, null, core.jsx(core.Stack, {
    ...
    listKey: listKey
  }), data.meta.count || filters.filters.length ? core.jsx(FilterAdd, {
    listKey: listKey
  }) : null, filters.filters.length ? core.jsx(FilterList, {
    filters: filters.filters,
    list: list
  }) : null), data.meta.count ? core.jsx(React.Fragment, null, core.jsx(ResultsSummaryContainer, null, (() => {
...
function ListTable({
  ...
  return core.jsx(core.Box, {
  ...
  }, core.jsx(TableContainer, null, core.jsx("colgroup", null, core.jsx("col", {
    width: "30"
    ...
    }))), shouldShowLinkIcon && core.jsx(TableBodyCell, null, core.jsx(router_dist_adminUi.Link, {
      css: {
        textDecoration: 'none',
        minHeight: 38,
        display: 'flex',
