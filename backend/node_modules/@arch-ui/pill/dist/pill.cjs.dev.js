...
const Pill = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  let {
    ...
    variant = 'subtle'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["appearance", "children", "onClick", "onRemove", "variant"]);

  return core.jsx(PillWrapper, _extends__default['default']({}, props, {
    ref: ref
  }), core.jsx(PillButton, {
