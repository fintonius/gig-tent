...
const HeaderButton = props => core.jsx("button", _extends__default['default']({
  type: "button",
  css: {
    background: 'none',
    borderRadius: theme.borderRadius,
...
const TextDayPicker = /*#__PURE__*/React.forwardRef((_ref, ref) => {
  let {
    ...
    format: displayFormat = 'do MMMM yyyy'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["date", "onChange", "format"]);
  ...
  return /*#__PURE__*/React__default['default'].createElement(input.Input, _extends__default['default']({
    ref: ref,
...
let TextDayTimePicker = (_ref) => {
  let {
    ...
    onChange
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["date", "onChange"]);
  ...
  return core.jsx(input.Input, _extends__default['default']({
    value: value,
    ref: ref,
