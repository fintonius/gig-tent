...
const SubtleText = styled__default['default'].span({
...
const Title = (_ref2) => {
  let {
    ...
    margin = 'none'
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["as", "crop", "margin"]);
...
const A11yText = (_ref3) => {
  let {
    tag: Tag = 'span'
      ...
      props = _objectWithoutProperties__default['default'](_ref3, ["tag"]);
