...
var _defineProperty = require("@babel/runtime/helpers/defineProperty"), core = require("@emotion/core"), react = require("react"), reactDom = require("react-dom"), flushable = require("flushable"), styled = require("@emotion/styled"), reactPopper = require("react-popper"), modalUtils = require("@arch-ui/modal-utils"), theme = require("@arch-ui/theme");
...
var _defineProperty__default = _interopDefault(_defineProperty), flushable__default = _interopDefault(flushable), styled__default = _interopDefault(styled);
...
const showTooltip = (fn, defaultDelay) => {
  ...
  isHidePending && pendingHide.flush();
  return flushable__default.default(fn, isHidePending ? 0 : defaultDelay).cancel;
}, hideTooltip = (fn, defaultDelay) => (pendingHide = flushable__default.default(fn, defaultDelay), 
pendingHide.cancel), Tooltip = ({children: children, content: content, onHide: onHide, onShow: onShow, placement: placement = "bottom", className: className, hideOnMouseDown: hideOnMouseDown, hideOnKeyDown: hideOnKeyDown, delay: delay = 300}) => {
  ...
  return react.useEffect(() => {
    ...
    const cancel = () => {
      ...
      fn = () => setIsVisible(!1), defaultDelay = delay, pendingHide = flushable__default.default(fn, defaultDelay), 
      cancelPendingSetState = pendingHide.cancel);
    };
