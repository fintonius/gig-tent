...
function FlexGroupComponent(_ref, ref) {
  let {
    ...
    stretch
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["align", "as", "children", "growIndexes", "isContiguous", "isInline", "isVertical", "justify", "wrap", "spacing", "stretch"]);
  ...
  return core.jsx(Tag, _extends__default['default']({
    ...
    }, isContiguous ? /*#__PURE__*/react.cloneElement(child, {
      style
    }) : child);
  }));
}
const FlexGroup = /*#__PURE__*/react.forwardRef(FlexGroupComponent); // ==============================
// Grid
// ==============================
// Grid Parent
// --------------------
...
const Grid = /*#__PURE__*/react.forwardRef((_ref2, ref) => {
  let {
    alignContent,
    areas,
    columns = 12,
    ...
    rows
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["alignContent", "areas", "columns", "flow", "gap", "justifyContent", "minRowHeight", "rows"]);
...
const Cell = (_ref3) => {
  let {
    ...
    width = 1
      ...
      props = _objectWithoutProperties__default['default'](_ref3, ["area", "height", "left", "top", "width"]);
