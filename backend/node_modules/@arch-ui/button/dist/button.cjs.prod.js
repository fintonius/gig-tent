...
var _extends = require("@babel/runtime/helpers/extends"), _objectWithoutProperties = require("@babel/runtime/helpers/objectWithoutProperties"), react = require("react"), core = require("@emotion/core"), styled = require("@emotion/styled"), loading = require("@arch-ui/loading"), _defineProperty = require("@babel/runtime/helpers/defineProperty"), reactRouterDom = require("react-router-dom"), reactPseudoState = require("react-pseudo-state"), theme = require("@arch-ui/theme"), common = require("@arch-ui/common"), colorUtils = require("@arch-ui/color-utils");
...
var _extends__default = _interopDefault(_extends), _objectWithoutProperties__default = _interopDefault(_objectWithoutProperties), styled__default = _interopDefault(styled), _defineProperty__default = _interopDefault(_defineProperty);
...
function makeBoldVariant({appearance: appearance, isDisabled: isDisabled, isActive: isActive, isHover: isHover, isFocus: isFocus, isSelected: isSelected}) {
  const {bg: bg, border: border, focusRing: focusRing, text: text} = boldAppearance[appearance], activeBg = "default" === appearance ? theme.colors.N10 : colorUtils.darken(bg, 12), hoverAndFocus = isHover || isFocus ? {
    borderColor: border,
    background: bg
  } : null, hoverStyles = isHover ? _objectSpread(_objectSpread({}, hoverAndFocus), {}, {
    boxShadow: "0 1px 2px rgba(0, 0, 0, 0.12)"
  }) : null, focusStyles = isFocus && !isDisabled ? _objectSpread(_objectSpread({}, hoverAndFocus), {}, {
    borderColor: focusRing,
    boxShadow: "0 0 0 3px " + colorUtils.alpha(focusRing || bg, .2)
  }) : null, activeStyles = isActive || isSelected ? {
    background: activeBg,
    borderColor: border
  } : null;
...
const SPACING_OPTION = {
  comfortable: `${theme.gridSize}px ${1.5 * theme.gridSize}px`,
  cozy: "2px 6px",
  cramped: "1px 2px"
};
...
function makeVariant({appearance: appearance = "default", isActive: isActive, isBlock: isBlock, isHover: isHover, isFocus: isFocus, isDisabled: isDisabled, isSelected: isSelected, variant: variant = "bold", spacing: spacing = "comfortable"}) {
  ...
  _objectSpread$1(_objectSpread$1({}, common.uniformHeight), {}, {
...
function ButtonElementComponent(props, ref) {
  const {isDisabled: isDisabled, isActive: isActive, isFocus: isFocus, isHover: isHover, isSelected: isSelected, focusOrigin: focusOrigin} = props, rest = _objectWithoutProperties__default.default(props, [ "isDisabled", "isActive", "isFocus", "isHover", "isSelected", "focusOrigin" ]), variant = makeVariant(props);
  return rest.to ? core.jsx(reactRouterDom.Link, _extends__default.default({
    ref: ref,
    css: variant
  }, rest)) : rest.href ? core.jsx("a", _extends__default.default({
    css: variant
  }, rest, {
    ref: ref
...
const ButtonElement = react.forwardRef(ButtonElementComponent), Button = reactPseudoState.withPseudoState(ButtonElement), LoadingButtonInner = styled__default.default.div({
  position: "relative"
}), LoadingIndicatorWrapper = styled__default.default.div({
  left: "50%",
  position: "absolute",
  top: "50%",
...
function LoadingButtonComponent(_ref, ref) {
  let {children: children, indicatorVariant: indicatorVariant, isLoading: isLoading} = _ref, props = _objectWithoutProperties__default.default(_ref, [ "children", "indicatorVariant", "isLoading" ]);
...
const LoadingButton = react.forwardRef(LoadingButtonComponent), IconButton = react.forwardRef((_ref, ref) => {
  let {children: children, icon: Icon, iconSize: iconSize = 16} = _ref, props = _objectWithoutProperties__default.default(_ref, [ "children", "icon", "iconSize" ]);
  return core.jsx(Button, _extends__default.default({
    ref: ref
  }, props), core.jsx("span", {
    css: {
