...
function makeVariant({
  ...
  return _objectSpread$1(_objectSpread$1({}, common.uniformHeight), {}, {
...
function ButtonElementComponent(props, ref) {
  const {
    ...
    focusOrigin
        ...
        rest = _objectWithoutProperties__default['default'](props, ["isDisabled", "isActive", "isFocus", "isHover", "isSelected", "focusOrigin"]);

  const variant = makeVariant(props);

  if (rest.to) {
    return core.jsx(reactRouterDom.Link, _extends__default['default']({
      ref: ref,
      css: variant
    }, rest));
  }
  ...
  if (rest.href) {
    return core.jsx("a", _extends__default['default']({
      css: variant
    }, rest, {
      ref: ref
    }));
...
function LoadingButtonComponent(_ref, ref) {
  let {
    ...
    isLoading
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["children", "indicatorVariant", "isLoading"]);
...
const IconButton = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  let {
    ...
    iconSize = 16
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["children", "icon", "iconSize"]);
