...
const ButtonProvider = ({
  ...
  const newContext = React.useMemo(() => _objectSpread2(_objectSpread2(_objectSpread2({}, parentContext), hooks), {}, {
...
const Button = core.forwardRefWithAs((_ref, ref) => {
  let {
    ...
    weight
      ...
      otherProps = _objectWithoutProperties__default['default'](_ref, ["as", "children", "isDisabled", "isLoading", "size", "tone", "weight"]);
