...
const VisuallyHidden = forwardRefWithAs((_ref, ref) => {
  let {
    as: Tag = 'span'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["as"]);
...
*/
const makeMq = breakpoints => facepaint__default['default'](Object.values(breakpoints).map(w => `@media (min-width: ${w}px)`)); // helper if array property declaration isn't appropriate
...
const Box = forwardRefWithAs((_ref, ref) => {
  ...
  const {
    ...
    width
        ...
        attrs = _objectWithoutProperties__default['default'](props, ["background", "foreground", "height", "margin", "marginTop", "marginRight", "marginBottom", "marginLeft", "marginY", "marginX", "padding", "paddingTop", "paddingRight", "paddingBottom", "paddingLeft", "paddingY", "paddingX", "rounding", "roundingBottom", "roundingLeft", "roundingRight", "roundingTop", "textAlign", "width"]);
  ...
  return react.jsx(Tag, _extends__default['default']({
    css: boxStyles,
    ref: ref
  }, attrs));
});
...
const Center = forwardRefWithAs((_ref, ref) => {
  let {
    fillView = false
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["fillView"]);

  return react.jsx(Box, _extends__default['default']({
    ref: ref,
    css: {
      alignItems: 'center',
      display: 'flex',
...
const Divider = (_ref) => {
  let {
    ...
    color
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["orientation", "color"]);
...
const Heading = forwardRefWithAs((_ref, ref) => {
  let {
    ...
    type = 'h1'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["as", "type"]);
...
const H1 = forwardRefWithAs((_ref2, ref) => {
  let {
    as = 'h1'
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["as"]);

  return react.jsx(Heading, _extends__default['default']({
    ref: ref,
    as: as,
    type: "h1"
  }, props));
...
const H2 = forwardRefWithAs((_ref3, ref) => {
  let {
    as = 'h2'
      ...
      props = _objectWithoutProperties__default['default'](_ref3, ["as"]);
...
const H3 = forwardRefWithAs((_ref4, ref) => {
  let {
    as = 'h3'
      ...
      props = _objectWithoutProperties__default['default'](_ref4, ["as"]);
...
const H4 = forwardRefWithAs((_ref5, ref) => {
  let {
    as = 'h4'
      ...
      props = _objectWithoutProperties__default['default'](_ref5, ["as"]);
...
const H5 = forwardRefWithAs((_ref6, ref) => {
  let {
    as = 'h5'
      ...
      props = _objectWithoutProperties__default['default'](_ref6, ["as"]);
...
const H6 = forwardRefWithAs((_ref7, ref) => {
  let {
    as = 'h6'
      ...
      props = _objectWithoutProperties__default['default'](_ref7, ["as"]);
...
const Inline = forwardRefWithAs((_ref, ref) => {
  let {
    ...
    gap = 'none'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["align", "children", "gap"]);
  ...
  return react.jsx(Box, _extends__default['default']({
    ...
    ref: ref
  }, props), React.Children.map(children, child => child !== null && child !== undefined ? react.jsx("div", {
    css: {
      display: 'flex',
      flexWrap: 'wrap',
...
const Stack = forwardRefWithAs((_ref, ref) => {
  let {
    ...
    gap = 'none'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["across", "align", "children", "dividers", "gap"]);
...
const Text = forwardRefWithAs((_ref, ref) => {
  let {
    ...
    weight = 'regular'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["color", "leading", "size", "tracking", "weight"]);
...
function useManagedState(controlledValue, defaultValue, onChange) {
  ...
  const [internalValue, setInternalValue] = React.useState(defaultValue); // warn consumers when their component is switching from controlled to uncontrolled and vice versa
