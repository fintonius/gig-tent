...
var DayPicker__default = /*#__PURE__*/_interopDefault(DayPicker);
...
const Checkbox = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  let {
    ...
    size
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["children", "className", "size"]);

  return core.jsx(ControlLabel, {
    className: className,
    size: size,
    control: core.jsx(CheckboxControl, _extends__default['default']({
      ref: ref,
      size: size
    }, props))
  }, children);
...
const CheckboxControl = /*#__PURE__*/react.forwardRef((_ref2, ref) => {
  let {
    ...
    size
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["className", "size"]);

  return core.jsx(react.Fragment, null, core.jsx(core.VisuallyHidden, _extends__default['default']({
    ref: ref,
    as: "input",
    type: "checkbox"
...
const Indicator = (_ref3) => {
  let {
    ...
    size
      ...
      props = _objectWithoutProperties__default['default'](_ref3, ["className", "size"]);
...
const FieldContainer = (_ref) => {
  ...
  return core.jsx("div", props, children);
};
...
const FieldLabel = core.forwardRefWithAs((_ref, ref) => {
  let {
    ...
    children
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["as", "children"]);
...
const FieldLegend = props => {
  ...
  return core.jsx("legend", _extends__default['default']({
    css: {
...
const Radio = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  ...
  return core.jsx(ControlLabel, {
    className: className,
    size: size,
    control: core.jsx(RadioControl, _extends__default['default']({
      ref: ref,
      size: size
    }, props))
  }, children);
...
const RadioControl = /*#__PURE__*/react.forwardRef((_ref2, ref) => {
  let {
    size
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["size"]);
...
const Switch = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  ...
  return core.jsx(ControlLabel, {
    className: className,
    control: core.jsx(SwitchControl, _extends__default['default']({
      ref: ref
    }, props))
  }, children);
});
const SwitchControl = /*#__PURE__*/react.forwardRef((_ref2, ref) => {
  let {
    ...
    onChange
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["a11yLabels", "checked", "onChange"]);
...
const useInputTokens = ({
  ...
  const {
    ...
    spacing,
    typography
  } = core.useTheme(); // const width = widthMap[widthKey];
...
const TextArea = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  let {
    ...
    width = 'large'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["invalid", "size", "width"]);
  ...
  return core.jsx("textarea", _extends__default['default']({
    rows: 4,
    ref: ref,
    css: styles
  }, props));
...
const TextInput = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  let {
    ...
    width = 'large'
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["invalid", "shape", "size", "type", "width"]);
...
function Select(_ref) {
  let {
    ...
    portalMenu
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["onChange", "value", "width", "portalMenu"]);
...
function MultiSelect(_ref2) {
  let {
    ...
    portalMenu
      ...
      props = _objectWithoutProperties__default['default'](_ref2, ["onChange", "value", "width", "portalMenu"]);
  ...
  return core.jsx(ReactSelect__default['default'] // css={{ width: tokens.width }}
...
const Calendar = (_ref) => {
  let {
    modifiers
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["modifiers"]);

  const styles = useCalendarStyles();
  const indexOfMonday = 1;
  const augmentedModifiers = react.useMemo(() => _objectSpread2(_objectSpread2({}, modifiers), {}, {
    weekend: {
      daysOfWeek: [0, 6]
    }
  }), [modifiers]);
  return core.jsx("div", {
    css: styles
  }, core.jsx(DayPicker__default['default'], _extends__default['default']({
...
const useAdornmentContext = () => react.useContext(AdornmentContext); // Adornment Wrapper
// ------------------------------
...
const Adornment = core.forwardRefWithAs((_ref, ref) => {
  let {
    align,
    as: Tag = 'div'
  } = _ref,
      props = _objectWithoutProperties__default['default'](_ref, ["align", "as"]);
...
const InputButton = /*#__PURE__*/react.forwardRef((_ref, ref) => {
  let {
    ...
    onClear
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["invalid", "isSelected", "onClear"]);
  ...
  return core.jsx(AdornmentWrapper, {
    shape: "square",
    size: "medium"
  }, core.jsx("button", _extends__default['default']({
...
const ClearButton = props => {
  ...
  return core.jsx(Adornment, _extends__default['default']({
    as: "button",
    align: "right",
    type: "button",
    tabIndex: -1,
...
const formatDMY = date => dateFns.format(date, 'MM/dd/yyyy');
...
const DatePicker = (_ref) => {
  let {
    ...
    onBlur
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["value", "onUpdate", "onClear", "onBlur"]);
  ...
  return core.jsx(react.Fragment, null, core.jsx(InputButton, _extends__default['default']({
  ...
  }), formattedDate || 'dd/mm/yyyy'), core.jsx(popover.PopoverDialog, _extends__default['default']({
    arrow: arrow,
    isVisible: isOpen,
    ref: dialog.ref
