...
const DrawerBase = (_ref) => {
  let {
    ...
    transitionState
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["children", "initialFocusRef", "onClose", "onSubmit", "width", "transitionState"]);
...
const DialogBase = (_ref) => {
  let {
    ...
    width
      ...
      props = _objectWithoutProperties__default['default'](_ref, ["children", "isOpen", "onClose", "width"]);
