...
describe('getDMMF', () => {
    ...
    test('model with autoincrement should fail if sqlite', async () => {
      ...
      model User {
        ...
        try {
            await engineCommands_1.getDMMF({ datamodel });
        }
        catch (e) {
  ...
  `,
    ...
    test('chinook introspected schema', async () => {
        const file = fs_1.default.readFileSync(path_1.default.join(__dirname, '../../fixtures/chinook.prisma'), 'utf-8');
        const dmmf = await engineCommands_1.getDMMF({
            datamodel: file,
        });
...
describe('format', () => {
    test('nothing', async () => {
        try {
            // @ts-expect-error
            await engineCommands_1.formatSchema({});
        }
        catch (e) {
    ...
    test('valid blog schemaPath', async () => {
        const formatted = await engineCommands_1.formatSchema({
