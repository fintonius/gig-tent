...
class MongooseMongoIdInterface extends adapterMongoose.MongooseFieldAdapter {
  ...
  getQueryConditions(dbPath) {
    ...
    return _objectSpread2(_objectSpread2({}, this.equalityConditions(this.field.isPrimaryKey ? '_id' : dbPath, s => s && mongoose.Types.ObjectId(s))), this.inConditions(this.field.isPrimaryKey ? '_id' : dbPath, s => s && mongoose.Types.ObjectId(s)));
  }
...
class KnexMongoIdInterface extends adapterKnex.KnexFieldAdapter {
  ...
  getQueryConditions(dbPath) {
    return _objectSpread2(_objectSpread2({}, this.equalityConditions(dbPath, normaliseValue)), this.inConditions(dbPath, normaliseValue));
  }
