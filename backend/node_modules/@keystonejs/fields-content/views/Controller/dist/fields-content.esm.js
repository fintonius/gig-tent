...
class ContentController extends Controller {
  constructor(_ref, ...args) {
    ...
    _defineProperty(this, "deserialize", data => {
      ...
      const parsedData = _objectSpread2(_objectSpread2({}, data[path]), {}, {
  ...
  `);
    ...
    this.getBlocks = memoizeOne(() => {
      ...
      const customBlocks = blocksModules.map(block => _objectSpread2(_objectSpread2({}, block), {}, {
        options: _objectSpread2(_objectSpread2({}, this.config.blockOptions[block.type]), {}, {
