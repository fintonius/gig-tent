 ...
 */
export declare type DaysModifiers = {
    [modifier: string]: DayMatcher;
};
/**
 * A type to indicate when a day matches a modifier.
 */
export declare type DayMatchModifier = boolean | undefined;
/**
 ...
 */
export declare type MatchDaysOfWeek = {
    daysOfWeek: number[];
};
/**
 * Matches any day for which this function returns a truthy value.
 */
export declare type MatchFunction = (date: Date) => boolean;
/**
 ...
 */
export declare type DayMatcher = MatchDate | MatchDayInRange | MatchDayBetween | MatchDayBefore | MatchDayAfter | MatchDaysOfWeek | MatchFunction | DayMatcher[];
