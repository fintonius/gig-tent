...
import { DayMatcher, DaysModifiers, MatchingModifiers, DaysClassNames, DaysStyles } from './Modifiers';
 ...
 */
export declare type DayPickerClassNames = {
 ...
 * element](./enumerations#daypickerelements).
 */
export declare type DayPickerStyles = {
    [name in DayPickerElements]?: React.CSSProperties;
};
/**
 * Event handler when a day is clicked.
 */
export declare type DayClickEventHandler = (day: Date, modifiers: MatchingModifiers, e: React.MouseEvent) => void;
/**
 * Event handler when the month is changed.
 */
export declare type MonthChangeEventHandler = (month: Date, e: React.MouseEvent) => void;
/**
